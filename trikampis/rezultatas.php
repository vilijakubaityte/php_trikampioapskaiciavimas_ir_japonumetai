    ...
    <div class="header">
        <div class="card my-5 col-md-6 d-flex align-items-center">
            <div class="card-header col-md-12 d-flex row gap-3 align-items-center">
                ...
                <div class="card-body">
                    <h3>Rezultatas: <span><?= $valid == true ? "Trikampį sudaryti galima" : "Trikampio sudaryti negalima" ?></span></h3>
                    <h3>Tipas: <span><?php if($valid == true) { echo $type; }?></span></h3>
                </div>
            </div>
        </div>
